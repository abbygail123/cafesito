...
<head>
  ...
  <!--icheck---->
  <link rel="stylesheet" href="../Desing/plugins/check/check/icheck-material.min.css">

  <!--tempusdominus---->
  <link rel="stylesheet" href="../Desing/plugins/datetime/datetime/build/css/tempusdominus-bootstrap-4.min.css">
...
<!----- moment time--->
<script src="../Desing/plugins/moment/moment-develop/min/moment-with-locales.min.js"></script>
<!----- tempus time--->
<script src="../Desing/plugins/datetime/datetime/build/js/tempusdominus-bootstrap-4.min.js"></script>

<!--- funciones propias-->
<script src="../Service/Service-Oferta.js"></script>
<script src="../Service/Service-Producto.js"></script>
