    ...
    ?>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-flat nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="../View/View-ListaUsuario.php" class="nav-link active">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../View/View-Categoria.php" class="nav-link">
                  <i class="fas fa-shapes nav-icon"></i>
                  <p>Categorías</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../View/View-Producto.php" class="nav-link">
                  <i class="fas fa-tshirt nav-icon"></i>
                  <p>Producto</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../View/View-Oferta.php" class="nav-link">
