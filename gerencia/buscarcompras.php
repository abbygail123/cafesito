<?php
  ...
  /*  if (isset($_GET['fech']) && $_GET['fech'] == "true") { $conx=$sesion->conexion();*/
     

     
      /* $resultado=mysqli_query($conx,$sqlfe);
      if(mysqli_num_rows($resultado)>0){

      } */

      $fecha_d= $_POST['fecha_de'];
      /* $fecha_des = explode('/', $fecha_d);
      $fecha_de = $fecha_des[2]."-".$fecha_des[0]."-".$fecha_des[1]; */

      $fecha_aa = $_POST['fecha_a'];
    /*   $fecha_as = explode('/', $fecha_aa);
      $fecha_a = $fecha_as[2]."-".$fecha_as[0]."-".$fecha_as[1]; */
        ...
        <div class="row">
          ...
          <div class="card col-sm-6">
            ...
            <form action="buscarcompras.php" method="post" class="input-group input-group-sm mb-3">
                ...
                <input style="color:gray;margin:-5px 10px 0 5px" type="date" name="fecha_de" id="fecha_de" value="<?php echo $fecha_d;?>" required>
                <h6 class="text-gray">A: </h6>
                <input style="color:gray;;margin:-5px 0 0 5px" type="date" name="fecha_a" id="fecha_a" value="<?php echo $fecha_aa;?>" required>
            ...
            <!-- tabla oferta -->
                ...
                <div class="col-lg">
                    <div  class="callout callout-danger">
                        ...
                        <?=tablaBuscarC($codU,$fecha_d,$fecha_aa,$conx);?>
                        </div>
                    </div> 
                </div>
